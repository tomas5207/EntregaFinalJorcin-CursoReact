...
const ItemCount = ({productId, productName, productDescription, productPrice, productImage }) => {
    ...
    const handleAddProductToCart = () => {
        ...
        if (productoExistente) {
            ...
            setCount([...count, {id: productId, name: productName, description: productDescription, price: precio ,quantity: countItem, image: productImage}]);
        }
